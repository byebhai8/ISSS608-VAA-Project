...
Our R Shiny application is titled "Visitor Arrival Analysis". This application contains three sections -- Summary, Explore and Forecast.

#### Summary Page

The following is the storyboard for the Summary Page.

![](images/proposal_05.png)

In this summary page, the following information will be captured:
